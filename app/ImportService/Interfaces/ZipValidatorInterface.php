...
interface ZipValidatorInterface
{
     ...
     *
     * @param string $datasetPath The base file path.
     ...
     */
    public function validateImageOrganization(string $datasetPath, string $imageFolder): void;

    /**
     * Validates the annotation folder structure and organization.
     *
     * @param string $datasetPath The base file path where annotations are stored.
     ...
     */
    public function validateAnnotationOrganization(string $datasetPath, string $labelExtension, ?string $annotationFolder = null): void;

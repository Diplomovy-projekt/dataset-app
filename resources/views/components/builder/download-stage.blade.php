<div class="bg-slate-800 rounded-lg shadow-lg border border-slate-700 p-4">
    <div class="flex flex-col gap-2">
        ...
        <div class="flex items-center gap-2 overflow-x-auto w-full max-w-full scrollbar-thin scrollbar-thumb-slate-600">
            <div class="flex items-center gap-2 bg-blue-500/20 px-2 py-1 rounded text-sm text-gray-300 whitespace-nowrap">
            ...
            <div class="flex items-center gap-2 bg-blue-500/20 px-2 py-1 rounded text-sm text-gray-300 whitespace-nowrap">
                ...
                12 Annotation Classes
            </div>
            <div class="flex items-center gap-2 bg-slate-700/50 px-2 py-1 rounded text-sm text-gray-300 whitespace-nowrap">

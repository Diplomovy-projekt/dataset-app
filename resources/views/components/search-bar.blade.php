...
<div class="flex-1 relative items-center bg-transparent w-full" {{ $attributes }}>
    ...
    <div class="absolute left-3 top-2.5 h-5 w-5 text-slate-500">
        ...
        <svg wire:loading.class="hidden" class="h-5 w-5 text-slate-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            <circle cx="11" cy="11" r="8"></circle>
            <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
        </svg>

        <!-- Loading spinner (shown during search) -->
        <svg wire:loading class="animate-spin h-5 w-5 text-blue-500 hidden" wire:loading.class.remove="hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">

...
<div {{ $attributes->class(['flex flex-col sm:flex-row justify-between sm:items-center bg-slate-800 rounded-lg sm:space-x-5 w-max h-max overflow-auto', 'text-xs' => !$attributes->has('class')]) }}>
    {{--Images--}}

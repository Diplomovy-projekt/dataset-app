...
<div x-data="{openDropdown: false}" class="relative z-50">
    <!-- Trigger Button -->
    <button
    ...
    <div x-show="openDropdown"
         ...
         style="display: none;"
         role="menu">
        <div {{ $attributes->merge(['class' => 'relative z-50 bg-slate-900 rounded-md shadow-lg ring-1 ring-black ring-opacity-5']) }}>
            {{ $slot }}
        </div>
    </div>
</div>

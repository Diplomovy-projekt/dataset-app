        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mb-8" x-data="{ activeTab: 'coco' }">
                <div class="flex border-b border-slate-700 mb-6">
                    ...
                    <button
                        @click="activeTab = 'pascalvoc'"
                        :class="activeTab === 'pascalvoc' ? 'border-blue-500 text-blue-500' : 'text-slate-400 hover:text-gray-200'"
                        class="py-3 px-6 font-medium border-b-2 transition-colors focus:outline-none"
                        :style="activeTab === 'pascalvoc' ? 'border-opacity: 1' : 'border-opacity: 0'"
                    >
                        Pascal VOC Format
                    </button>
                </div>
